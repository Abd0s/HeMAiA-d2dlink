...
`ifdef TARGET_NORTHONLY
`define NORTH_IO (1)
`define EAST_IO (0)
`define WEST_IO (0)
`define SOUTH_IO (0)
`elsif TARGET_EASTONLY
`define NORTH_IO (0)
`define EAST_IO (1)
`define WEST_IO (0)
`define SOUTH_IO (0)
`elsif TARGET_WESTONLY
`define NORTH_IO (0)
`define EAST_IO (0)
`define WEST_IO (1)
`define SOUTH_IO (0)
`elsif TARGET_SOUTHONLY
`define NORTH_IO (0)
`define EAST_IO (0)
`define WEST_IO (0)
`define SOUTH_IO (1)
...
% if occamy_cfg['hemaia_multichip']['single_chip'] is False:
  ...
  hemaia_d2d_link #(
    ...
    .netframe_clk_i(clk_host),
    .netframe_rst_ni(rst_ni),
    .netroute_clk_i(clk_host),
    ...
    // Currently the router is implemented, so bidirectional connections toward E/S/W/N is needed, with 597b payload
    .link_available_east_i,
    .datalink_frame_to_east_i,
    .datalink_frame_to_east_valid_o,
    .datalink_frame_to_east_ready_i,
    .datalink_frame_from_east_i,
    .datalink_frame_from_east_valid_i,
    .datalink_frame_from_east_ready_o,
    // West side
    .link_available_west_i,
    .datalink_frame_to_west_i,
    .datalink_frame_to_west_valid_o,
    .datalink_frame_to_west_ready_i,
    .datalink_frame_from_west_i,
    .datalink_frame_from_west_valid_i,
    .datalink_frame_from_west_ready_o,
    // North side
    .link_available_north_i,
    .datalink_frame_to_north_i,
    .datalink_frame_to_north_valid_o,
    .datalink_frame_to_north_ready_i,
    .datalink_frame_from_north_i,
    .datalink_frame_from_north_valid_i,
    .datalink_frame_from_north_ready_o,
    // South side
    .link_available_south_i,
    .datalink_frame_to_south_i,
    .datalink_frame_to_south_valid_o,
    .datalink_frame_to_south_ready_i,
    .datalink_frame_from_south_i,
    .datalink_frame_from_south_valid_i,
    .datalink_frame_from_south_ready_o
  );
