...
% if occamy_cfg['hemaia_multichip']['single_chip'] is False:
  ...
  hemaia_d2d_link #(
    ...
    .payload_from_east_i,
    .payload_from_east_valid_i,
    .payload_from_east_ready_o,
    .payload_to_east_o,
    .payload_to_east_valid_o,
    .payload_to_east_ready_i,
    // West side
    .link_available_west_i,
    .payload_from_west_i,
    .payload_from_west_valid_i,
    .payload_from_west_ready_o,
    .payload_to_west_o,
    .payload_to_west_valid_o,
    .payload_to_west_ready_i,
    // North side
    .link_available_north_i,
    .payload_from_north_i,
    .payload_from_north_valid_i,
    .payload_from_north_ready_o,
    .payload_to_north_o,
    .payload_to_north_valid_o,
    .payload_to_north_ready_i,
    // South side
    .link_available_south_i,
    .payload_from_south_i,
    .payload_from_south_valid_i,
    .payload_from_south_ready_o,
    .payload_to_south_o,
    .payload_to_south_valid_o,
    .payload_to_south_ready_i
  );
