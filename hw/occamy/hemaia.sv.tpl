...
% if multichip_cfg["single_chip"] is False:
    ...
    output logic     [1023:0] datalink_frame_to_east_i,
    output logic              datalink_frame_to_east_valid_o,
    input  logic              datalink_frame_to_east_ready_i,
    input  logic     [1023:0] datalink_frame_from_east_i,
    input  logic              datalink_frame_from_east_valid_i,
    output logic              datalink_frame_from_east_ready_o,
    // West side
    input  logic              link_available_west_i,
    output logic     [1023:0] datalink_frame_to_west_i,
    output logic              datalink_frame_to_west_valid_o,
    input  logic              datalink_frame_to_west_ready_i,
    input  logic     [1023:0] datalink_frame_from_west_i,
    input  logic              datalink_frame_from_west_valid_i,
    output logic              datalink_frame_from_west_ready_o,
    // North side
    input  logic              link_available_north_i,
    output logic     [1023:0] datalink_frame_to_north_i,
    output logic              datalink_frame_to_north_valid_o,
    input  logic              datalink_frame_to_north_ready_i,
    input  logic     [1023:0] datalink_frame_from_north_i,
    input  logic              datalink_frame_from_north_valid_i,
    output logic              datalink_frame_from_north_ready_o,
    // South side
    input  logic              link_available_south_i,
    output logic     [1023:0] datalink_frame_to_south_i,
    output logic              datalink_frame_to_south_valid_o,
    input  logic              datalink_frame_to_south_ready_i,
    input  logic     [1023:0] datalink_frame_from_south_i,
    input  logic              datalink_frame_from_south_valid_i,
    output logic              datalink_frame_from_south_ready_o,
% endif
    // `uart` Interface (4)
